      ...
      if (
        ...
        if (MAP_STATE[selected[0]][selected[1]].split("-")[0] === "n") {
          ...
          if (active[1] == selected[1]) {
            if (
              Math.max(parseInt(active[1]), parseInt(selected[1])) -
                Math.min(parseInt(active[1]), parseInt(selected[1])) <
              remaining
            ) {
              let start, end;
              ...
              MAP_STATE[selected[0]][selected[1]] = "0-" + remaining;
            }
          } else if (active[0] == selected[0]) {
            if (
              Math.max(parseInt(active[0]), parseInt(selected[0])) -
                Math.min(parseInt(active[0]), parseInt(selected[0])) <
              remaining
            ) {
              let start, end;
